...
class SwitchCenterTest(unittest.TestCase):
    def test_lookup(self):
        one = TestSwitch(TestSwitch.OPEN)
        two = TestSwitch(TestSwitch.OPEN)
    ...
    def test_all_names(self):
        center = SwitchCenter((('one', TestSwitch(TestSwitch.OPEN)), ('two', TestSwitch(TestSwitch.OPEN))))
    ...
    def test_duplicate(self):
        self.assertRaises(HeatingError, SwitchCenter, (('one', TestSwitch(TestSwitch.OPEN)), ('one', TestSwitch(TestSwitch.OPEN))))
