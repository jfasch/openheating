...
class CircuitTest(unittest.TestCase):
    ...
    def test__look__takes_datetime_and_timestamp(self):
        ...
        self.__circuit.look(0) # epoch
        self.__circuit.look(datetime.datetime.fromtimestamp(1)) # epoch+1
